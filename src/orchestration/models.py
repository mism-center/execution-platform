...
launching batch model-execution containers.
"""
...
@dataclass(slots=True, kw_only=True)
class SystemSpec:
    """Complete specification for a MISM batch execution pod.

    This is the execution-platform equivalent of Tycho's ``System``, stripped
    to only what's needed for headless batch execution via K8s Jobs.
    """
